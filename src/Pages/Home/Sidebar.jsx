...
//         } fixed top-0 left-0 w-30 h-screen bg-gray-900 text-white transition-transform transform lg:relative lg:translate-x-0`}
//       >
  ...
  return (
    <div>
      ...
      <div
        className={`${
          isOpen ? "translate-x-0" : "-translate-x-full"
        } fixed top-0 left-0 w-64 h-screen bg-gray-900 text-white transition-transform transform lg:relative lg:translate-x-0 lg:w-72`}
      >
        {/* Close button for mobile */}
        <div className="lg:hidden p-4 text-right">
          <CloseIcon onClick={toggleSidebar} className="text-white" />
